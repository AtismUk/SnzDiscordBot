...
public class SettingsService : ISettingsService
{
    ...
    public async Task<SettingsEntity?> GetSettingsAsync(ulong guildId)
    {
        ...
        return await _baseRepo.FirstOrDefaultAsync<SettingsEntity>(s => s.GuildId == guildId) ?? await AddUpdateSettingsAsync(guildId, requesterIsGetter: true);
    }

    public async Task<SettingsEntity?> AddUpdateSettingsAsync(ulong guildId, ulong? auditChannelId = null, ulong? applicationChannelId = null, ulong? applicationAddRoleId = null, ulong? applicationRemoveRoleId = null, ulong? newsChannelId = null, ulong? eventsChannelId = null, ulong? scheduleChannelId = null, bool requesterIsGetter = false)
    {
